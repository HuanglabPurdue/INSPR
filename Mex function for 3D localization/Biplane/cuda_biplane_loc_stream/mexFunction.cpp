 ...
 */
	...
	float *tMat = 0;	//Affine matrix
	float *offset_int = 0;	//interger offset
	...
	tMat = (float*)mxGetData(prhs[19]);	//affine model
	offset_int = (float*)mxGetData(prhs[20]);
	...
	outsize3[0] = NCH*psfsize*Nfit;		//2 channel, edited by FX
	...
	mFit.tMat = tMat;	//affine parameters
	mFit.offset_int = offset_int;
